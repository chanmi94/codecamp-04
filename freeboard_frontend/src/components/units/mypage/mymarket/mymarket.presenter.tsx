...
import { IMyMarketUI } from "./mymarket.types";
import { IUseditem } from "../../../../commons/types/generated/types";
export default function MyMarketUI(props: IMyMarketUI) {
      ...
      <Wrapper>
        ...
        {!props.isPickList ? (
          <WrapperBody>
            ...
            {props.data?.fetchUseditemsISold.map((el: IUseditem) => (
              <Row key={el._id}>
          ...
          <WrapperBody>
            ...
            {buyData?.fetchUseditemsIBought?.map((el: IUseditem) => (
              <Row key={el._id}>
