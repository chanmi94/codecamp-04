  ...
  useEffect(() => {
    ...
    script.onload = () => {
      window.kakao.maps.load(function () {
        ...
        var polygonPath = [
          new window.kakao.maps.LatLng(37.48449133367579, 126.90230210115773),
          new window.kakao.maps.LatLng(37.48458498239565, 126.90165837099995),
          new window.kakao.maps.LatLng(37.48421890036874, 126.90201242258675),
